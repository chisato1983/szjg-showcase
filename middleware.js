...
export default async function middleware(req) {
  ...
  const isProtected = /^\/(gdp|dashboard|fire-event-detail|fire-cockpit|fire-control-room|yuzhong-risks|fire-water|elevator-monitor|fire-vehicle-wartime)(\/|$)/.test(path);
